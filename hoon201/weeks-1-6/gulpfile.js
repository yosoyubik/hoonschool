...
gulp.task('tile-js-imports', function(cb) {
  return gulp.src('dist/tile.js')
    ...
    .pipe(gulp.dest('./src/app/week7/js/'))
    .on('end', cb);
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./src/app/week7/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./src/app/week7/js/'));
});
...
gulp.task('watch', gulp.series('default', function() {
  gulp.watch('./week7-tile/**/*.js', gulp.parallel('tile-js-bundle-dev'));
